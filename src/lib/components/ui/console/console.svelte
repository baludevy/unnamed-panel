...
<div class="flex flex-col gap-2 w-full">
    <div class="flex flex-col rounded-lg border border-zinc-800 bg-zinc-950 overflow-hidden shadow-inner">
        <div
            bind:this={viewport}
            ...
            {#each logs as log}
                <div
                    ...
                    {log.type === 'warn' ? 'text-yellow-400 bg-yellow-400/5' : 
                     ...
                     log.type === 'system' ? 'text-blue-400 bg-blue-400/5' : ''}"
                >
                    <span class="opacity-30 select-none">[{new Date().toLocaleTimeString([], { hour12: false })}]</span>
